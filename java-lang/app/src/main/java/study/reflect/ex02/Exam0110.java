...
public class Exam0110 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 2) 중첩 클래스
    Class<?> clazz2 = Class.forName("study.reflect.ex02.Exam01$A");

    // 클래스의 타입 객체를 통해 클래스 정보를 추출할 수 있다.
    System.out.println(clazz2.getSimpleName()); // A
    System.out.println(clazz2.getName()); // study.reflect.ex02.Exam01$A
    System.out.println(clazz2.getCanonicalName()); // study.reflect.ex02.Exam01.A
    System.out.println(clazz2.getTypeName()); // study.reflect.ex02.Exam01$A
    ...
    System.out.println(clazz3.getName()); // study.reflect.ex02.Exam01$1
    System.out.println(clazz3.getCanonicalName()); // null
    System.out.println(clazz3.getTypeName()); // study.reflect.ex02.Exam01$1
  }
