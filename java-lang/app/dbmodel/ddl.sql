...
CREATE TABLE edu_apply (
	...
	created_date DATETIME NOT NULL DEFAULT now() COMMENT '수강신청일', -- 수강신청일
...
CREATE TABLE edu_lecture (
	...
	online     TINYINT      NULL     COMMENT '비대면' -- 비대면
)
COMMENT '교육과정';
...
CREATE TABLE edu_manager (
	...
	position   VARCHAR(50) NULL     COMMENT '매니저', -- 매니저
...
CREATE TABLE edu_room (
	...
	center_id INTEGER     NOT NULL COMMENT '교육센터 번호' -- 교육센터 번호
)
COMMENT '강의장';
...
ALTER TABLE edu_center
	MODIFY COLUMN center_id INTEGER NOT NULL AUTO_INCREMENT COMMENT '교육센터 번호';
