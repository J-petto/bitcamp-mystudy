...
public class ProjectController {
    ...
    public String form1(HttpServletResponse res) throws Exception {
    ...
    public String form3(@RequestParam("member") int[] memberNos, HttpSession session) throws Exception {
        ...
        if(memberNos.length > 0){
            ...
            for(int memberNo : memberNos){
                members.add(userService.get(memberNo));
            }
