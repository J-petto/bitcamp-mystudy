...
public class NcpObjectStorageService implements StorageService {
    ...
    public void upload(String filePath, InputStream in, Map<String, Object> options) throws Exception {
        ...
        objectMetadata.setContentType((String) options.get(StorageService.CONTENT_TYPE)); // 콘텐츠의 MIME Type 정보를 설정함

        PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName,// 업로드할 버킷 이름
