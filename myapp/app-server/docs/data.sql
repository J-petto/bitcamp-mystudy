-- 회원 데이터
insert into myapp_users(user_id, name, email, pwd)
values (1, 'admin', 'admin@test.com', sha1('1111')),
...
-- 게시글 데이터
insert into myapp_boards(board_id, title, content, user_id)
values (1, '제목1', '내용', 11),
       (2, '제목2', '내용', 11),
       (3, '제목3', '내용', 13),
       (4, '제목4', '내용', 16),
...
-- 프로젝트 데이터
insert into myapp_projects(project_id, title, description, start_date, end_date)
values (101, '프로젝트1', '설명', '2024-1-1', '2024-2-15'),
