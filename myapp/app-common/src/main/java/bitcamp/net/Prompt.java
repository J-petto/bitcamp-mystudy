...
public class Prompt {
  ...
  private StringWriter strWriter = new StringWriter(); // 서버에서 출력하는 것을 임시 보관하는 역할
  // 문자열을 다양한 형식으로 출력할 수 있도록 도와주는 데코레이터
  // 이 객체를 사용하여 출력한 내용은 모두 위의 StringWriter에 보관됨
