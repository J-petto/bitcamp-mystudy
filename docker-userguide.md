...
```
$ sudo docker build -t hminji/bitcamp:myapp .
```

sudo docker push hminji/bitcamp:myapp

sudo docker run -d --name myapp -p 80:80 -v /home/student/config:/root/config hminji/bitcamp
sudo docker run -d --name myapp2 -p 81:80 -v /home/student/config:/root/config hminji/bitcamp

#### 컨테이너 생성 및 실행하기

Windows OS
```
$ docker run -d -p 80:80 -v /mnt/c/Users/bitcamp/config:/root/config --name myapp2 hminji/bitcamp:myapp
```
